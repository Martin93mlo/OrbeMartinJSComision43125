...
signinBtn.onclick = function(){
    ...
    signupBtn.classList.add("button.disable");
    signinBtn.classList.remove("button.disable");
...
signupBtn.onclick = function(){
    ...
    signupBtn.classList.remove("button.disable");
    signinBtn.classList.add("button.disable");
